...
export default async function AdminDashboardPage() {
  ...
  // We can fetch flip webhooks if needed, but for now we'll assume 0 unmatched for a new store
  const unmatchedFlip = 0; // Or fetch from Prisma if implemented
  const revenueChange = 0; // Simplify for now
